import { Image, Container, ProfileCard, Profile } from './styles/StyleMain'
		...
		<Container>
			<ProfileCard>
				...
				<Profile>
					...
					<p>Meu nome é Ygor e tenho 23 Anos</p>
					<p>
						Meu Trabalho é usar o <div id="java">JavaScript</div> para colocar
						sua ideia na internet
					</p>
					<p>
